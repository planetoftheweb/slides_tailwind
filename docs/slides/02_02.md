...
Most of the styles in Tailwind are designed to mimic CSS property/value pairs. One of the richest set of classes related to typography is the text property. Let's take a look at that and also learn how to customize directives (which is just another name for commands) in Tailwind.
