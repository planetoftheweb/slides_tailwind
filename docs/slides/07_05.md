...
Technically this next feature is under interactivity in the Tailwind CSS manual, but I think it belongs here. It allows you to conrol how the user can select some text inside an element.
